...
output_name=data/wmt_europarlv7_en2de_v32k
...
#src_train=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.0p01.train
#tgt_train=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.0p01.train
#src_test=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.0p01.test
#tgt_test=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.0p01.test
#src_val=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.0p01.val
#tgt_val=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.0p01.val
#output_name=data/wmt_europarlv7_en2en_v5k_0p01

#src_train=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.0p1.train
#tgt_train=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.0p1.train
#src_test=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.0p1.test
#tgt_test=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.0p1.test
#src_val=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.0p1.val
#tgt_val=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.0p1.val
#output_name=data/wmt_europarlv7_en2en_v5k_0p1

#src_train=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.train
#tgt_train=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.train
#src_test=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.test
#tgt_test=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.test
#src_val=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.val
#tgt_val=data/oridata/wmt_ende_sp_preprocess/europarl-v7.de-en.en.sp.val
#output_name=data/wmt_europarlv7_en2en_v5k

#src_train=data/oridata/DialogDataFromBenben/douban_data_seg_done_v2/q_train_150w
#tgt_train=data/oridata/DialogDataFromBenben/douban_data_seg_done_v2/r_train_150w
#src_test=data/oridata/DialogDataFromBenben/douban_data_seg_done_v2/q_test_5w
#tgt_test=data/oridata/DialogDataFromBenben/douban_data_seg_done_v2/r_test_5w
#src_val=data/oridata/DialogDataFromBenben/douban_data_seg_done_v2/q_val_1w
#tgt_val=data/oridata/DialogDataFromBenben/douban_data_seg_done_v2/r_val_1w
#output_name=data/db_bb2_q2r_v10w3w

src_vocab_size=32000
tgt_vocab_size=32000

alias pythont='/bigstore/hlcm2/tianzhiliang/test/software/anaconda3_5_1_0_pytorch0_4_1/bin/python'
pythont preprocess.py -max_shard_size 50000000 -train_src ${src_train} -train_tgt ${tgt_train} -valid_src ${src_val} -valid_tgt ${tgt_val} -test_src ${src_test} -test_tgt ${tgt_test} -save_data ${output_name} -src_vocab_size ${src_vocab_size} -tgt_vocab_size ${tgt_vocab_size}
